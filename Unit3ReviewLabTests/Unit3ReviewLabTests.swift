...
import XCTest
@testable import Unit3ReviewLab

class Unit3ReviewLabTests: XCTestCase {
    ...
    func test2Podcast() {
         ...
         """.data(using: .utf8)!
                            ...
                            // act
                            let searchResults = try! JSONDecoder().decode(PodcastData.self, from: jsonData)
